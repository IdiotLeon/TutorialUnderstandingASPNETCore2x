...
namespace Globoma.Services
{
    public class ProposalMemoryService : IProposalService
    {
        ...
        public ProposalMemoryService()
        {
            ...
            proposals.Add(new ProposalModel { Id = 2, ConferenceId = 2, Speaker = "John Reynolds", Title = "Starting Your Developer Career" });
            proposals.Add(new ProposalModel { Id = 3, ConferenceId = 2, Speaker = "Stan Lipens", Title = "ASP.NET Core TagHelpers" });
        }
